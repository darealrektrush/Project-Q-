...
function rewardsScreen() {
  ...
  const commitmentRows = commitments.campaignRewards ? [
    ...
    ['Diamond Duck bonus', `${formatBaseUnits(commitments.diamondDuckBonus.amountBaseUnits)} FAWKQ`, 'Squads community vault · part of the 17.5M FAWKQ campaign commitment'],
