...
function fixture() {
  return {
    ...
    drawCommitments: [
      { campaign_id: 'bond-the-duck-2026', cycle_id: 2, protocol_version: 'bond-draw-v1', commit_hash: 'e'.repeat(64), committed_at: '2026-08-31T12:00:00Z' },
      { campaign_id: 'bond-the-duck-2026', cycle_id: 1, protocol_version: 'bond-draw-v1', commit_hash: 'f'.repeat(64), committed_at: '2026-08-31T12:00:00Z' },
    ],
    sources: [
